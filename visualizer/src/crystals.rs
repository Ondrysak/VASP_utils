//! Built-in crystal library ported from the HTML Crystal Field Synthesizer.
//! 34 structures across all 7 crystal systems.
...
/// Flat list of all crystals in order (same as HTML CRYSTALS array).
