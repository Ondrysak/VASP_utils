...
#[derive(Parser)]
#[command(about = "Convert POSCAR coordinates from Direct (fractional) to Cartesian")]
struct Cli {
    #[arg(short, long, default_value = "POSCAR")]
    input: String,
    #[arg(short, long, default_value = "POSCAR_cartesian")]
    output: String,
}
...
fn main() {
    ...
    if poscar.is_direct {
        ...
        println!("POSCAR is already in Cartesian coordinates");
    }
